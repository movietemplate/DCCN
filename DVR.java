...
public class DVR 
{
 ...
 public static void main(String args[]) throws IOException
 {
  ...
  v = sc.nextInt();//Integer.parseInt(br.readLine());
  
  System.out.println("Please enter the number of Edges: ");
  e = sc.nextInt();//Integer.parseInt(br.readLine());
  ...
  for(int i = 0; i < e; i++)
  {
   ...
   int s = sc.nextInt();//.parseInt(br.readLine());
   s--;
   System.out.print("Destination: ");
   int d = sc.nextInt();//Integer.parseInt(br.readLine());
   d--;
   System.out.print("Cost: ");
   int c = sc.nextInt();//Integer.parseInt(br.readLine());
   graph[s][d] = c;
   graph[d][s] = c;
  }
